...
namespace ServiceModelEx.ServiceFabric.Actors
{
   internal class ActorChannelInvoker<I> where I : class,IActor
   {
      ...
      {
         CallInvoker invoker = new CallInvoker(typeof(I),factory,actorid);
      ...
      class CallInvoker : RealProxy
      {
         ...
         public CallInvoker(Type classToProxy,ChannelFactory<I> factory,ActorId actorId) : base(classToProxy)
         {
            m_Factory = factory;
            m_ActorId = actorId;
         }
